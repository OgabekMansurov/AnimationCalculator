...
class LoansController: UIViewController {
    ...
    private let MortgageValue = CustomTextField(fieldType: .mortgageValue, backgroundColor: UIColor(hexString: "D2691E"))
    private let interestRate = CustomTextField(fieldType: .interestRate, backgroundColor: UIColor(hexString: "D2691E"))
    private let MonthlyPayment = CustomTextField(fieldType: .MonthlyPayment, backgroundColor: UIColor(hexString: "D2691E"))
    private let noOfYearsTime = CustomTextField(fieldType: .noOfYearsTime, backgroundColor: UIColor(hexString: "D2691E"))
    ...
    @objc private func calculate() {
        ...
        if MortgageValue.checkIfEmpty() == false && interestRate.checkIfEmpty() == false && MonthlyPayment.checkIfEmpty() == false && noOfYearsTime.checkIfEmpty() == true{
            ...
            loan.loanAmount = Double(MortgageValue.text!)!
            loan.interest = Double(interestRate.text!)!
            loan.payment = Double(MonthlyPayment.text!)!
            
            noOfYearsTime.text = String(loan.calculateNumberOfPayments())
            ...
            loan.loanAmount = Double(MortgageValue.text!)!
            loan.interest = Double(interestRate.text!)!
            loan.numberOfPayments = Int(Double(noOfYearsTime.text!)!)
            
            MonthlyPayment.text = String(loan.calculateMonthlyPayment())
            ...
            MortgageValue.text = String(loan.calculateLoanAmount())
            ...
            interestRate.text = String(loan.calculateAnnualInterestRate())
